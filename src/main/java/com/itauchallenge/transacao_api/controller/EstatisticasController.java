package com.itauchallenge.transacao_api.controller;

import com.itauchallenge.transacao_api.business.services.EstatisticasService;
...
public class EstatisticasController {
    ...
    public ResponseEntity<EstatisticasResponseDTO> buscarEstatisticas(
        ...
        return ResponseEntity.ok(estatisticasService.calcularEstatisticaDeTrasacoes(intervaloDeBusca));
    }
